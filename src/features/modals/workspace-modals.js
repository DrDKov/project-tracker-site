...
export function createWorkspaceModals(deps) {
  ...
  function openProject(id) {
    ...
    if (window.__ReactWorkspaceModals && typeof window.__ReactWorkspaceModals.openProject === 'function') {
      window.__ReactWorkspaceModals.openProject(project, { defaultOwnerId: S.profile?.id || null });
      return;
    }
  ...
  function openUser(id) {
    ...
    if (window.__ReactWorkspaceModals && typeof window.__ReactWorkspaceModals.openUser === 'function') {
      window.__ReactWorkspaceModals.openUser(user);
      return;
    }
  ...
  function openAccess(projectId) {
    const project = byId(S.projects, projectId) || { id: projectId };
    if (window.__ReactWorkspaceModals && typeof window.__ReactWorkspaceModals.openAccess === 'function') {
      window.__ReactWorkspaceModals.openAccess(project);
      return;
    }
