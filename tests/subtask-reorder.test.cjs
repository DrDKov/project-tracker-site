...
assert.match(loader, /app-runtime\.js\?v=20260728-task-comment-composer-v1/);
assert.match(deployTransform, /ver='20260728-task-comment-composer-v1'/);
...
assert.match(fs.readFileSync(path.join(root, 'index.html'), 'utf8'), /app\.css\?v=20260728-task-comment-composer-v1/);
