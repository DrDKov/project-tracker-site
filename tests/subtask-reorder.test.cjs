...
assert.match(deployTransform, /ver='20260814-native-pickers-v1'/);
...
assert.match(fs.readFileSync(path.join(root, 'index.html'), 'utf8'), /app\.css\?v=20260814-native-pickers-v1/);
