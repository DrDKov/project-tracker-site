...
assert.match(loader, /app-runtime\.js\?v=20260911-timeline-materials-v2/);
assert.match(deployTransform, /ver='20260911-timeline-materials-v2'/);
...
assert.match(fs.readFileSync(path.join(root, 'index.html'), 'utf8'), /app\.css\?v=20260911-timeline-materials-v2/);
