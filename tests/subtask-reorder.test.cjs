...
assert.match(loader, /app-runtime\.js\?v=20260813-subtask-attention-v1/);
assert.match(deployTransform, /ver='20260813-subtask-attention-v1'/);
...
assert.match(fs.readFileSync(path.join(root, 'index.html'), 'utf8'), /app\.css\?v=20260813-subtask-attention-v1/);
